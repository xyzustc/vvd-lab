...
HD_PWD='/home/ubuntu/lab2_fifo/lab2_fifo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fifo.tcl -notrace
