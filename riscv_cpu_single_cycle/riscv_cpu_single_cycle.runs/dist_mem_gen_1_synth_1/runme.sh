...
HD_PWD='/home/ubuntu/riscv_cpu_single_cycle/riscv_cpu_single_cycle.runs/dist_mem_gen_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dist_mem_gen_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dist_mem_gen_1.tcl
