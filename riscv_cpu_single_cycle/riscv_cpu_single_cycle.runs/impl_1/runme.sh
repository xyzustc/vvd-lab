...
HD_PWD='/home/ubuntu/riscv_cpu_single_cycle/riscv_cpu_single_cycle.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_proj.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cpu_proj.tcl -notrace
