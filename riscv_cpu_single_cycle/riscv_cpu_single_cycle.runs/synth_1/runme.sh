...
HD_PWD='/home/ubuntu/riscv_cpu_single_cycle/riscv_cpu_single_cycle.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_proj.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpu_proj.tcl
