...
cpu_pl cpu_inst (
    ...
    .pc(pc),
    .pcd(pcd),
    .pce(pce),//   input [31:0] pcin, pc, pcd, pce,
    .ir(ir),
    .imm(imm),
    .mdr(mdr),//   input [31:0] ir, imm, mdr,
    .a(a),
    .b(b),
    .y(y),
    .bm(bm),
    .yw(yw),//   input [31:0] a, b, y, bm, yw,
    .rd(rd),
    .rdm(rdm),
    .rdw(rdw),//   input [4:0]  rd, rdm, rdw,
    .ctrl(ctrl),
    .ctrlm(ctrlm),
    .ctrlw(ctrlw)//   input [31:0] ctrl, ctrlm, ctrlw  
);
